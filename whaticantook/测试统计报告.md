...
项目规模不大，但业务链路比较完整：主源码约 4.5k 行 Kotlin/Java，包含 Onboarding、Discover、Search、Pantry、Recipe Detail、Favorites、Settings 等主要页面，使用 Room、Hilt、Navigation-Compose、Repository/MVVM 分层。
